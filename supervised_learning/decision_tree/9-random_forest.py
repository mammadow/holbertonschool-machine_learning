#!/usr/bin/env python3
"""Module implementing a Random Forest classifier."""
import numpy as np
Decision_Tree = __import__('8-build_decision_tree').Decision_Tree


class Random_Forest():
    """Represents a random forest ensemble of decision trees."""

    def __init__(self, n_trees=100, max_depth=10, min_pop=1, seed=0):
        """Initializes a Random_Forest with hyperparameters and seed."""
        self.numpy_predicts = []
        self.target = None
    ...
    def fit(self, explanatory, target, n_trees=100, verbose=0):
        """Trains n_trees random decision trees on the given data."""
        self.target = target
